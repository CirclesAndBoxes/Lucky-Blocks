...
execute on origin if entity @s[nbt={SelectedItem:{components:{"minecraft:damage":64,"minecraft:custom_data":{"WarHook":1}}}}] run item replace entity @s weapon with air
